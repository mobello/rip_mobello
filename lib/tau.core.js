...
(function (GLOBAL) {
  ...
  if (typeof tau == 'undefined') {
    ...
    tau = {
       ...
       * tau.log('mobello', 1); // "[614] mobello" (614 is milliseconds)
...
//          }
  ...
  $class('tau.ArrayHelper').define({
     ...
     * @example
     * var a = [1, 2, 3];
     * var arr = new tau.ArrayHelper(a);
     * arr.pushUnique(4); // true 
     * // a is [1, 2, 3, 4]
     *
