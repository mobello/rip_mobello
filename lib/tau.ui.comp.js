...
$class('tau.ui.Container').mixin(tau.ui.ContainerDrawable).define({
   ...
   * 
   * @param {String | Number} 컴포넌트 ID 혹은 배열 인덱스
   * @throws {RangeError} 명시된 index가 범위를 벗어났을 때
...
$class('tau.ui.Scene').extend(tau.rt.EventDelegator)
   ...
   *  <ul>
   *   <li>
   *      Mobello Studio를 통해 위직윅방식으로 Scene을 생성
   *   </li>
   *   <li>
   *    SceneController 클래스의 Naming Convention을 이용해 생성되는 
   *    [controller].scene.js의 initScene function을 통해 생성
   *    <pre>
   *    <code>
   *    // main.scene.js
   *    initScene function () {
...
$class('tau.ui.Component').extend(tau.rt.EventDelegator).mixin(
   ...
   * </article>
   * <aritcle>
   *  <header><h3>컴포넌트 이벤트 처리</h3></hearder>
   * <ol>
...
$class('tau.ui.Button').extend(tau.ui.Component).define({
   ...
   * 대표적인 기능 :
   * <ul>
   *   <li>스타일 클래스 설정: 모양, 타입, 크기에 따른 스타일 클래스 설정(see: {@link #setStylesClass})</li>
   *   <li>
   *    <dl>
   *      <dt>'normal'</dt>
   *      <dd>기본</dd>
